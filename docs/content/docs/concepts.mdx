...
- [Security Model & Cryptography](/docs/architecture/security-model): PBKDF2 parameters, AES-256-GCM AEAD, and container layout.
- [In-Memory Injection Architecture](/docs/architecture/in-memory-injection): Process spawning and memory lifecycle.
- [CLI Reference](/docs/cli/overview): Guide to all MayFly CLI commands.
