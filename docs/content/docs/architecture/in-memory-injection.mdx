...
- [Cryptographic Audit Chain](/docs/architecture/audit-chain): How execution events are recorded.
- [Security Model & Cryptography](/docs/architecture/security-model): AES-256-GCM AEAD details.
- [CLI Reference: Run](/docs/cli/run): Complete CLI flags for the `run` command.
